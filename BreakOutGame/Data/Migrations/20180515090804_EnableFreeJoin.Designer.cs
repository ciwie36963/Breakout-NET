...
namespace BreakOutGame.Data.Migrations
{
    ...
    [Migration("20180515090804_EnableFreeJoin")]
    partial class EnableFreeJoin
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BreakOutGame.Models.Domain.BoBSession", b =>
                {
                    ...
                    b.Property<bool>("AreActionsEnabled")
                        .HasColumnName("ActionsEnabled");

                    b.Property<int>("BoxId")
                        .HasColumnName("BOX_ID");

                    b.Property<string>("CLASSROOM_STUDENTCLASSNAME");
                    ...
                    b.HasIndex("CLASSROOM_STUDENTCLASSNAME");
            ...
            modelBuilder.Entity("BreakOutGame.Models.Domain.Student", b =>
                {
                    ...
                    b.Property<string>("STUDENTCLASS_STUDENTCLASSNAME");

                    b.HasKey("Id");

                    b.HasIndex("STUDENTCLASS_STUDENTCLASSNAME");

                    b.ToTable("Student");
                });

            modelBuilder.Entity("BreakOutGame.Models.Domain.StudentClass", b =>
                {
                    b.Property<string>("ClassName")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("STUDENTCLASSNAME");
            ...
            modelBuilder.Entity("BreakOutGame.Models.Domain.BoBSession", b =>
                {
                    b.HasOne("BreakOutGame.Models.Domain.StudentClass", "StudentClass")
                        .WithMany()
                        .HasForeignKey("CLASSROOM_STUDENTCLASSNAME");
                });
            ...
            modelBuilder.Entity("BreakOutGame.Models.Domain.Student", b =>
                {
                    b.HasOne("BreakOutGame.Models.Domain.StudentClass", "StudentClass")
                        .WithMany("Students")
                        .HasForeignKey("STUDENTCLASS_STUDENTCLASSNAME");
                });
